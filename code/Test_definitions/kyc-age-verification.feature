Feature: CAMARA KYC Age Verification API, v0.2.1-rc.2 - Operation verifyAge
  ...
  #
  # References to OAS spec schemas refer to schemas specifies in kyc-age-verification.yaml, version v0.2.1-rc.2

  Background: Common verifyAge setup
    Given an environment at "apiRoot"
    And the resource "/kyc-age-verification/v0.2rc2/verify"
